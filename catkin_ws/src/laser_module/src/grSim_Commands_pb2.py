...
_GRSIM_COMMANDS = _descriptor.Descriptor(
  ...
  filename=None,grSim_Packet_pb2
  file=DESCRIPTOgrSim_Packet_pb2
  containing_typgrSim_Packet_pb2
  fields=[
    _descriptor.grSim_Packet_pb2
      name='timegrSim_Packet_pb2
      number=1, grSim_Packet_pb2
      has_defaulgrSim_Packet_pb2
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
